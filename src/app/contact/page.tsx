...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black overflow-hidden" ref={containerRef}>
      {/* Decorative elements */}
      <motion.div 
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24 relative">
        ...
        >
          ...
          >
            ...
            >
              Whether you&apos;re interested in prints, collaborations, or just want to share your thoughts about photography, I&apos;d love to hear from you.
            </motion.p>
            ...
            {!isSubmitted ? (
              ...
              >
                ...
                >
                  <div className="space-y-2">
                    <label htmlFor="name" className="block font-mono text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                      Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="block font-mono text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                      Email
                    </label>
                    <input
                      type="email"
                ...
                <motion.div variants={item} className="space-y-2">
                  <label htmlFor="subject" className="block font-mono text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                    Subject
                  </label>
                  <input
                    type="text"
                ...
                <motion.div variants={item} className="space-y-2">
                  <label htmlFor="message" className="block font-mono text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                    Message
                  </label>
                  <textarea
                    id="message"
                ...
                >
                  ...
                  >
                    ...
                    <motion.span 
                      className="absolute inset-0 bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-100 dark:to-white opacity-0 group-hover:opacity-100 duration-300 transition-opacity"
                    ></motion.span>
                  </button>
                </motion.div>
              </motion.form>
              ...
              >
                ...
                <h2 className="text-2xl font-serif text-gray-900 dark:text-white mb-3">Message Sent!</h2>
