...
export default function Home() {
  ...
  const heroSlides = featuredPhotos.map((photo) => ({
    ...
    description:
      photo.description ||
      "A photographic journey through moments of stillness and motion",
      ...
      <section className="py-24 md:py-32 bg-gradient-to-b from-black/90 to-black">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center gap-16">
            <motion.div className="md:w-1/2 space-y-6" style={{ y: y1 }}>
            ...
            <motion.div className="md:w-1/2" style={{ y: y2 }}>
              <div className="relative h-[600px] rounded-2xl overflow-hidden shadow-apple-dark">
                ...
                {featuredPhotos[0] && (
                  <Image
                    src={
                      featuredPhotos[0].src.startsWith("/photos/")
                        ? featuredPhotos[0].src.replace(
                            "/photos/",
                            "/api/photos/",
                          )
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20">
                  <span className="inline-block text-xs font-mono text-white/60 mb-2">
                    FEATURED
                  </span>
                  ...
                  <p className="text-white/70">
                    {featuredPhotos[0]?.description ||
                      "Capturing stillness in motion with modern tools and classic techniques"}
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        <div className="absolute inset-0">
          {featuredPhotos[1] && (
            <Image
              src={
                featuredPhotos[1].src.startsWith("/photos/")
