    ...
    <div className="min-h-screen bg-white dark:bg-black" ref={containerRef}>
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24">
        ...
        <motion.div
          ...
          className="mb-16 p-6 rounded-2xl backdrop-blur-md bg-white/5 dark:bg-black/10 border border-gray-200/10 dark:border-gray-800/20 shadow-apple dark:shadow-apple-dark"
        >
          <div className="text-center">
            <motion.div
              ...
              className="text-xs md:text-sm text-gray-500 dark:text-gray-400 uppercase tracking-[3px] mb-2"
            >
          ...
          >
            ...
            >
              <motion.p variants={item}>
                My journey in photography began in October 2024, exploring the world through the lens of my iPhone 16 Pro. This modern tool became my gateway into the art of visual storytelling, teaching me the fundamentals of composition and light.
              </motion.p>
              
              <motion.p variants={item}>
                In January 2025, I took a step into analog photography with my Yashica FX1. The mechanical process of film photography has given me a deeper appreciation for each frame and the thoughtfulness required in capturing moments.
              </motion.p>
            ...
            >
              <h2 className="font-serif text-xl text-gray-900 dark:text-white">Equipment & Timeline</h2>
              <ul className="space-y-4">
                {['2024: iPhone 16 Pro', '2025: Yashica FX1', 'Coming Soon: Fujifilm X-S20'].map((item, i) => (
                  <motion.li 
                    key={i}
