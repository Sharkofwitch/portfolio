...
export default function Footer() {
  ...
  return (
    <motion.footer 
      ...
      className="mt-auto py-16 bg-gradient-to-b from-gray-900/0 to-gray-900/10 dark:from-black/0 dark:to-black/80 border-t border-gray-200/10 dark:border-gray-800/20"
    >
      <motion.div 
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 border-b border-white/5 dark:border-white/5">
          {/* Brand */}
          <motion.div variants={item} className="flex flex-col space-y-4">
            <h3 className="font-serif text-3xl text-gray-900 dark:text-white">
              szark<span className="font-mono text-xs align-top opacity-70">.org</span>
            </h3>
            <p className="text-gray-500 dark:text-gray-400 font-light max-w-xs">
              Capturing modern nostalgia through digital and analog photography since 2024.
            </p>
          </motion.div>
          
          {/* Links */}
          <motion.div variants={item} className="flex flex-col space-y-4">
            <h4 className="font-mono text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wider">Navigation</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={link.href}>
                  <a 
                    href={link.href}
                    className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200 relative group inline-block"
                  >
                    {link.label}
          ...
          {/* Social */}
          <motion.div variants={item} className="flex flex-col space-y-4">
            <h4 className="font-mono text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wider">Connect</h4>
            <div className="flex flex-col space-y-2">
              ...
              >
                <span className="w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center mr-3 group-hover:bg-gray-200 dark:group-hover:bg-gray-700 transition-colors">
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <motion.div 
            variants={item}
            className="flex space-x-6 text-sm text-gray-500 dark:text-gray-500"
          >
