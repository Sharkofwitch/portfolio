/**
 * Database refresh script for the image system (TypeScript version)
 * 
...
export async function refreshDatabase(): Promise<RefreshResult> {
  try {
    ...
    console.error('Error refreshing database:', errorMessage);
    return {
      success: false,
      error: errorMessage
    };
